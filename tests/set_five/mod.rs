...
fn challenge_forty() {
    ...
    let mut c_0 = BigUint::from_bytes_be(&c_0_buf);
    let mut c_1 = BigUint::from_bytes_be(&c_1_buf);
    let mut c_2 = BigUint::from_bytes_be(&c_2_buf);
    ...
    let res = c_0.mod_floor(&n_012).cbrt().to_bytes_be();
